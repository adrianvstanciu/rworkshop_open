...
**NOTE**: Make sure that the data you've downloaded from GESIS website is stored in your working directory. 

```{r}
# in-between "..." delete my path and paste the path of your folder where the data is stored on your machine

## if you deposit the original data from the GESIS website in your working directory use
path_df <- ""

## if you deposit the original data from the GESIS website in a sub-folder in your working directory (called data, for instance) use
## path_df <- "data/"
```
